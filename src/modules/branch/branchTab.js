...
const { TabPane } = Tabs;
const { BRANCH: {
    BRANCH_NAME, TYPE_OF_BUSSINESS, ADDRESS1, ADDRESS2, CITY, COUNTRY_STATE, COUNTRY, POSTCODE, TAX, INDUSTRY, CONTACT_NAME, DESIGNATION, EMAIL_1, EMAIL_2, PHONE_1, PHONE_2, TAB_LEGAL, TAB_CONTACT, TAB_BTN
} } = LABELS
            ...
            <Tabs defaultActiveKey="1" type="card" size="Medium">
                <TabPane tab={TAB_LEGAL} key="1">
                    ...
                    >
                        <Row justify="center">
                            <Col span={12}>
                                <Form.Item label={BRANCH_NAME} name={BRANCH_NAME}>
                                    <Input />
                                </Form.Item>
                            </Col>
                            <Col span={12}>
